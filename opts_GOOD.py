...
def parse_args():
    ...
    parser.add_argument('--beta',
                        type=float,
                        default=1,
                        help='prototype loss parameter')
    parser.add_argument('--me_batch_n',
                        type=int,
                        default=8,
                        help='the num of memory bank batch')
    parser.add_argument('--prototype', type=str2bool, default=False)
    parser.add_argument('--memory', type=str2bool, default=False)
    # parser.add_argument('--task_type',
    #                     type=str,
    #                     default="'Multi-label classification")
    parser.add_argument('--dim_node', type=int, default=-1)
    ...
    # parser.add_argument('--model', type=str, default="Causal", help="GCN, GIN")
...
#     def model_func4(num_features, num_classes, K):
#         return CausalGCN(num_features, num_classes, K, args)

#     def model_func5(num_features, num_classes):
#         return Causal(num_features, num_classes, args)
