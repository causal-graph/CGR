...
do
  ...
  do
    ...
    LOG_FILE="./log/CAL/${DATASET}_${DOMAIN}_${SHIFT}.log"

    # Run the experiment with nohup and log output
    nohup python -u train_real.py \
      --dataset $DATASET \
      --domain $DOMAIN \
      --shift $SHIFT \
      --beta $BETA \
    ...
    echo "Running ZINC dataset with domain $DOMAIN and shift $SHIFT. Logging to $LOG_FILE."
  done
done
